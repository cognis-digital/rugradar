#!/usr/bin/env sh
# Universal installer for rugradar. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/rugradar.git"
echo "Installing rugradar ..."
